...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" >Ученик</a>
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
              <ul class="nav flex-column mb-2">
                <li class="nav-item">
                  <a class="nav-link <?=($CURRENT_PAGE=='student_cab'?'active':'')?>" href="<?=conf::$SITE_URL?>student_cab/">
                    <i class="fas fa-user-edit"></i> Мой профиль
                  </a>
                </li>
<!--                <li class="nav-item">
                  <a class="nav-link <?=($CURRENT_PAGE=='news'?'active':'')?>" href="<?=conf::$SITE_URL?>student_cab/news">
                    <i class="fas fa-list"></i> Новости
                  </a>
                </li>-->
                <li class="nav-item">
                  <a class="nav-link <?=($CURRENT_PAGE=='classmates'?'active':'')?>" href="<?=conf::$SITE_URL?>student_cab/classmates">
                    <i class="fas fa-user-friends"></i> Одноклассники
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link <?=($CURRENT_PAGE=='teachers'?'active':'')?>" href="<?php echo conf::$SITE_URL ?>student_cab/teachers">
                    <i class="fas fa-user-graduate"></i> Учителя
                  </a>
                </li>
              </ul><br/>
              <ul class="nav flex-column mb-2">
                <li class="nav-item">
                  <a class="nav-link <?=($CURRENT_PAGE=='journal'?'active':'')?>" href="<?=conf::$SITE_URL?>student_cab/journal">
                    <i class="fas fa-address-book"></i> Журнал
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link <?=($CURRENT_PAGE=='homework'?'active':'')?>" href="<?=conf::$SITE_URL?>student_cab/homework">
...
<!--              <ul class="nav flex-column mb-2">
                <li class="nav-item">
                  <a class="nav-link <?=($CURRENT_PAGE=='education'?'active':'')?>" href="<?=conf::$SITE_URL?>student_cab/education">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <?php
            if ($content_view <> '') {
               include 'system/views/student/' . $content_view;
            }
            ?>
