$(function () {
    ...
    $(".edit").on("click", function () {
        ...
        var user_group = $("#"+id+" .user_group").attr("id");
        $('#edit_users #user_group').val(user_group);
        $.ajax({
            url: "get_user_info_by_id",
            type: "POST",
            data: {
                id: id, user_group: user_group
            },
        ...
        if (is_load) {
            $.ajax({
                ...
                data: {
                    ...
                    user_group: $("#edit_users #user_group").val(),
